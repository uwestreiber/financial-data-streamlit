...
options = ['NVD.DE','ETH-EUR', 'ZAL.DE', 'TL0.DE', 'YOU.DE', '47R.F', 'HFG.DE', 'ARM', 'ONTO', '1CIA.BE']
...
fig1_old.add_trace(go.Scatter(x=data.index, y=data['Close'], name=f'Price (Latest: {latest_close_price:.2f})', line=dict(color='blue')))
...
fig1_old.add_trace(go.Scatter(x=data.index, y=data['RSI'], name=f'RSI (Latest: {latest_rsi:.2f})', line=dict(color='rgba(128, 0, 128, 0.3)'), yaxis="y2"))
...
fig1.add_trace(go.Candlestick(
    ...
    low=data['Low'],
    close=data['Close'],
    name=f'Candlestick (Latest: {latest_close_price:.2f})',
...
# Unteres Diagramm: Kaufsignale als grüne Dreiecke und Verkaufssignale als rote Dreiecke
